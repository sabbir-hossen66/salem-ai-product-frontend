...
export const translations: Record<string, Record<Language, string>> = {
  ...
  "value.title":              { en: "How We Create Value", ar: "بناء القيمة عبر كل القطاعات" },
  "value.desc":               {
  ...
  // Strengths - Why Choose Us (merged, de-duplicated)
