    ...
    <section className="w-full bg-[#FAF8F5] py-20 md:py-28 px-6 font-sans flex justify-center items-center">
      <div className="max-w-3xl mx-auto text-center flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-center">
          ...
          {/* Primary Button */}
          <button className="cursor-pointer bg-[linear-gradient(105deg,#745B00_0%,#FFC300_100%)] text-white px-8 py-3 text-sm md:text-base font-bold transition-colors duration-300 flex items-center justify-center gap-2">
          ...
          {/* Secondary Button */}
          <button className="cursor-pointer border border-[#A48639] text-[#A48639] px-8 py-3 text-sm md:text-base font-bold transition-colors duration-300 flex items-center justify-center gap-2">
