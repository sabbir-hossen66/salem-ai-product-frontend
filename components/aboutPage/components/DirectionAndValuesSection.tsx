    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {[1, 2, 3, 4, 5, 6].map((num) => (
                <div 
                    key={num}
                    className="group bg-[#F6F3ED] border-none p-8 lg:p-10 flex flex-col shadow-sm cursor-pointer transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:border-[#FFE180] hover:bg-[#FDFBF7]"
                >
